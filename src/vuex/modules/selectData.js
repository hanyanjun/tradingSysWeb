const selectData = {
    state : {
        ...
        trustTable : [
            ...
            {title : '时间', dataIndex : 'time' , key : '16' ,width : 150 ,scopedSlots : {customRender : 'Ts'}},
            {title : '货币对', dataIndex : 'Symbol' ,  width : 100 ,key : '3' },
            {title : '策略类型', dataIndex : 'dataType' , key : '15' ,  width : 140 ,scopedSlots : {customRender : 'dataType'}},
            {title : '交易类型', dataIndex : 'Side' , key : '4' , width : 80 , scopedSlots : {customRender : 'Side'}},
            {title : '价格上限', dataIndex : 'Price' ,  width : 100 ,key : '5'},
            {title : '已下单数量', dataIndex : 'OrderPlaced' , key : '14' ,   width : 150 ,scopedSlots : {customRender : 'OrderPlaced'}},
            {title : '档位范围', dataIndex : 'PriceRange' , key : '6' , width : 80 ,scopedSlots : {customRender : 'PriceRange'}},
            {title : '委托比例', dataIndex : 'Rate' , key : '7', width : 80 ,scopedSlots : {customRender : 'Rate'}},
            {title : '总委托数量', dataIndex : 'TotalAmount' , key : '8', width : 120 ,scopedSlots : {customRender : 'TotalAmount'}},
            {title : '时间间隔基数', dataIndex : 'MinTimeInterval' ,  width : 150 ,key : '9'},
            {title : '单笔委托基数', dataIndex : 'EveryAmount' , key : '10', width : 150 ,scopedSlots : {customRender : 'EveryAmount'}},
            {title : '附加条件', dataIndex : 'condition' , key : '17', width : 280 ,scopedSlots : {customRender : 'condition'}},
            {title : '状态', dataIndex : 'Finished' , key : '12', width : 150 ,scopedSlots : {customRender : 'Finished'}},
